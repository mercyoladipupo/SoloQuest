...
const ConnectTravelers = () => {
    ...
    const fetchAllData = async () => {
        await Promise.all([fetchUsers(), fetchFriends(), fetchRequests(), fetchBlockedUsers()]);
        setLoading(false);
    };

    const fetchUsers = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/users/`, { headers: getAuthHeaders() });
    ...
    const fetchFriends = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/friends/`, { headers: getAuthHeaders() });
    ...
    const fetchRequests = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/friend-requests/`, { headers: getAuthHeaders() });
    ...
    const fetchBlockedUsers = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/blocked-users/`, { headers: getAuthHeaders() });
    ...
    const acceptFriendRequest = async (requestId) => {
        try {
            await axios.post(`${API_BASE_URL}/api/accept-friend-request/${requestId}/`, {}, { headers: getAuthHeaders() });
            fetchFriends();
            fetchRequests();
        } catch (error) {
    ...
    const deleteFriendRequest = async (requestId) => {
        try {
            await axios.delete(`${API_BASE_URL}/api/delete-friend-request/${requestId}/`, { headers: getAuthHeaders() });
    ...
    const blockUser = async (userId) => {
        try {
            await axios.post(`${API_BASE_URL}/api/block-user/${userId}/`, {}, { headers: getAuthHeaders() });
            fetchBlockedUsers();
        } catch (error) {
    ...
    const unblockUser = async (blockedId) => {
        try {
            await axios.post(`${API_BASE_URL}/api/unblock-user/${blockedId}/`, {}, { headers: getAuthHeaders() });
            fetchBlockedUsers();
        } catch (error) {
